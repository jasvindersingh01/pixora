                        ...
                        user ?
                            <div className='flex items-center gap-2 sm:gap-3'>
                                <button onClick={() => navigate("/buy-credits")} className='flex items-center gap-2 cursor-pointer bg-purple-200 py-1.5 sm:py-3 px-4 sm:px-6 rounded-full hover:scale-105 transition-all duration-700'>
                                    <img className='w-5' src={assets.credit} alt="credits" />
                                ...
                                <div className='relative group'>
                                    <img src={assets.profile_icon} className='w-10' alt="profile" onClick={() => setOpen((prev) => !prev)} />
                                    <div className={`absolute top-0 right-0 z-10 text-black rounded pt-12
                                    ${open ? "block" : "hidden"} md:group-hover:block`}>
                                        <ul className='list-none m-0 p-2 bg-white rounded-md border text-sm'>
                                            <li onClick={logout} className='py-1 px-2 cursor-pointer pr-8'>
                                                Logout
                                            </li>
                                        </ul>
                                    </div>
