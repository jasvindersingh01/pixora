        ...
        >
            ...
            >
                ...
                >
                    ...
                    <input type="email" className="outline-none text-sm" placeholder="Email Address" required />
                </motion.div>
                ...
                <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="w-full text-white py-2 rounded-full bg-gradient-to-r from-purple-600 via-pink-500 to-orange-400 hover:opacity-90 transition"
                >
